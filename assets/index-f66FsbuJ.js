...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dc(e,t,n){let r=new Float32Array(Zs),i=new K(0,1,0);return new To({name:`SphericalGaussianBlur`,defines:{n:Zs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:mc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fc(){return new To({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:mc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function pc(){return new To({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mc(),fragmentShader:`
	...
	`}var hc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Bl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Vl(e,t){let n=Bl[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Hl=new K;function Ul(){return J.getLuminanceCoefficients(Hl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Hl.x.toFixed(4)}, ${Hl.y.toFixed(4)}, ${Hl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ml(i,i.VERTEX_SHADER,y),S=Ml(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Rl(i,x,`vertex`),n=Rl(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Kd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},qd=new cs(-1,1,1,-1,0,1),Jd=new class extends Er{constructor(){super(),this.setAttribute(`position`,new X([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new X([0,2,0,0,2,0],2))}},Yd=class{constructor(e){this._mesh=new mi(Jd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,qd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Xd=class extends Kd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof To?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=So.clone(e.uniforms),this.material=new To({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Yd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Zd=class extends Kd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Qd=class extends Kd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},$d=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Xd(Gd),this.copyPass.material.blending=0,this.timer=new hs}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Zd!==void 0&&(r instanceof Zd?n=!0:r instanceof Qd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ef=class extends Kd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},tf={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}_getCompositeMaterial(e){return new To({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};nf.BlurDirectionX=new G(1,0),nf.BlurDirectionY=new G(0,1);var rf={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
		...
		}`},af={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
		...
		}`},of={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
		...
		}`},lf=class extends Kd{constructor(){super(),this.isOutputPass=!0,this.uniforms=So.clone(cf.uniforms),this.material=new Eo({name:cf.name,uniforms:this.uniforms,vertexShader:cf.vertexShader,fragmentShader:cf.fragmentShader}),this._fsQuad=new Yd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},uf=class extends Nn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Bi;e.deleteAttribute(`uv`);let t=new Do({side:1}),n=new Do,r=new ss(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new mi(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Ei(e,n,6),o=new Cn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new mi(e,df(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new mi(e,df(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new mi(e,df(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new mi(e,df(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new mi(e,df(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new mi(e,df(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function df(e){return new ko({color:0,emissive:16777215,emissiveIntensity:e})}var ff=7.6,pf=.6,mf=3.5,hf=1.5,gf=5.5,_f=3.2;function $(e){return-e*ff}function vf(e){return $(e)+7}function yf(e){return Math.min(144,Math.max(1,Math.ceil(-e/ff)))}var bf={grade:0,roofCap:-.6,top:$(1),bottom:$(144),bottomSlab:$(144)-pf,genFloor:$(144)-pf-30,capBottom:$(144)-pf-30-9,voidFloor:$(144)-pf-30-9-45};function xf(e){return e/(2*Math.PI)*ff/2}function Sf(e,t){let n=((e*60+t*120)%360+360)%360,r=n*Math.PI/180;return{a:r,deg:n,y:$(e)+xf(r)}}function Cf(e,t){return[t*Math.cos(e),t*Math.sin(e)]}var wf=Math.PI/180,Tf=[{id:`top`,name:`上层区`,from:1,to:49,accent:`#e0c48a`},{id:`mids`,name:`中层区`,from:50,to:119,accent:`#8fb2a8`},{id:`deep`,name:`深层区`,from:120,to:144,accent:`#e0902e`},{id:`below`,name:`地下深处`,from:145,to:148,accent:`#c8481c`}];function Ef(e){return Tf.find(t=>e>=t.from&&e<=t.to)||Tf[3]}var Df={concrete:`#8a8578`,concreteStain:`#5d5346`,concreteDamp:`#4a4a42`,tread:`#9a9484`,nosing:`#b2ab99`,rail:`#23262a`,railGreen:`#2e3a36`,steelDoor:`#3a3f3d`,barricade:`#2f3336`,stencil:`#e6e2d6`,plaque:`#1f2220`,plaqueTeal:`#1d3a3c`,numeral:`#e9e2cf`,sconceWarm:`#ffd9a0`,panelCool:`#e8f0ff`,petal:`#dfe8f2`,rib:`#7d786b`,bezel:`#5a5750`,screenGround:`#6b5a40`,screenSky:`#b8b4a8`,falseMeadow:`#6fa04a`,falseSky:`#8fbbe0`,paintTeal:`#3f7a78`,paintGreen:`#5f7a4a`,paintOchre:`#a67c3a`,bazaarRed:`#b8342a`,bulb:`#ffb070`,wood:`#6b4a2f`,brass:`#b08d4a`,emblem:`#b9975b`,gantry:`#2c2c2a`,rust:`#7a4a2a`,generatorGlow:`#ff8c2a`,alarm:`#d92b1e`,fluoGreen:`#cfe8c8`,grow:`#ff3f7a`,foliage:`#3f8a3a`,vault:`#6f7478`,vaultStrip:`#cfe6ff`,hologram:`#5fd0ff`,s17Concrete:`#5a564c`,moss:`#4a5a36`,s17Rust:`#6e3f22`,s17Glow:`#7fa07a`,water:`#1f4a48`,waterDeep:`#0c1e22`,pipe:`#6a6a66`,crt:`#3ddc84`,crtBg:`#061a10`,earth:`#2a231c`,earthLight:`#4a3b2c`,dust:`#8a7a62`,hazeSky:`#b9ae98`},Of={waterlineLevel:22.5,waterY:-22.5*ff,poweredLevel:19,survivorsLevel:18,blownBridgeLevel:19,pumpLevel:30},kf={18:{hemiSky:`#cdbfa8`,hemiGround:`#2a231c`,hemiI:.55,keyI:1.7,keyColor:`#fff0da`,fillI:.35,exposure:1,fog:`#8e9088`,fogDensity:22e-5,bloom:.42,bloomR:.38,bloomT:3,grade:.55,envI:.35,skyLift:1},17:{hemiSky:`#8aa695`,hemiGround:`#121915`,hemiI:.3,keyI:.62,keyColor:`#b3cbba`,fillI:.16,exposure:1,fog:`#080d0b`,fogDensity:4e-4,bloom:.6,bloomR:.42,bloomT:2.6,grade:1,envI:.1,skyLift:.85}};function Af(e){let{scene:t,renderer:n,camera:r}=e,i={current:e.silo.mode,settings:{...kf[e.silo.mode]}},a=new mi(new mo(9e3,48,24),new To({uniforms:{uLift:{value:1},uSun:{value:new K(.35,.42,-.85).normalize()}},side:1,depthWrite:!1,fog:!1,vertexShader:`varying vec3 vDir; void main(){ vDir = normalize(position); gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }`,fragmentShader:`uniform float uLift; uniform vec3 uSun; varying vec3 vDir;
      void main(){
        float h = clamp(vDir.y, -1.0, 1.0);
        vec3 horizon = vec3(0.70, 0.70, 0.63);   // pale dust haze (the S1E10 aerial: bright overcast, grey-green)
        vec3 zenith  = vec3(0.50, 0.53, 0.51);   // overcast, slightly green
        vec3 below   = vec3(0.045, 0.04, 0.034);   // the studio floor under the cutaway: darkest thing in frame
        vec3 col = h >= 0.0 ? mix(horizon, zenith, pow(h, 0.55)) : mix(horizon, below, clamp(-h * 9.0, 0.0, 1.0));
        float s = max(dot(vDir, uSun), 0.0);
        col += vec3(0.95, 0.92, 0.82) * (pow(s, 24.0) * 0.55 + pow(s, 4.0) * 0.16);   // a smeared bright patch, not a sun
        gl_FragColor = vec4(col * uLift, 1.0);
      }`}));a.frustumCulled=!1,a.renderOrder=-2,a.name=`sky`,t.add(a);let o=new qo(13483944,2761500,.55);t.add(o);let s=new us(16773338,1.7);s.castShadow=e.perf.shadows&&e.params.shadow!==`0`;let c=Math.min(e.perf.shadowMapSize,2048);n.shadowMap.autoUpdate=e.params.shadowmode===`always`,n.shadowMap.needsUpdate=!0,e.silo.onChange(()=>{n.shadowMap.needsUpdate=!0}),s.shadow.mapSize.set(c,c),s.shadow.camera.near=20,s.shadow.camera.far=2600,s.shadow.bias=-5e-4,s.shadow.normalBias=.5,s.shadow.radius=2,t.add(s,s.target);let l=new us(10466248,.35);t.add(l,l.target);let u=new K(.38,.72,1).normalize(),d=new K(-.7,.25,.65).normalize();t.fog=new Mn(9343112,22e-5),t.environment=new oc(n).fromScene(new uf,.04).texture,t.environmentIntensity=.35;function f(e){o.color.set(e.hemiSky),o.groundColor.set(e.hemiGround),o.intensity=e.hemiI,s.color.set(e.keyColor),s.intensity=e.keyI,l.intensity=e.fillI,n.toneMappingExposure=e.exposure,t.fog.color.set(e.fog),t.fog.density=e.fogDensity,t.environmentIntensity=e.envI,a.material.uniforms.uLift.value=e.skyLift,v&&(v.strength=e.bloom,v.radius=e.bloomR,v.threshold=e.bloomT),y&&(y.uniforms.uAmount.value=e.grade)}let p=new K(1e9,0,0),m=new K,h=0;function g(){let t=e.controls.target,i=r.position.distanceTo(t);(r.position.distanceToSquared(p)>1e-4||t.distanceToSquared(m)>1e-4)&&(p.copy(r.position),m.copy(t),h=3),h>0&&(n.shadowMap.needsUpdate=!0,h--);let a=wd(i*1.1,30,800),o=s.shadow.camera;Math.abs(o.right-a)>1&&(o.left=-a,o.right=a,o.top=a,o.bottom=-a,o.updateProjectionMatrix()),s.position.copy(t).addScaledVector(u,1200),s.target.position.copy(t),s.target.updateMatrixWorld(),l.position.copy(t).addScaledVector(d,1e3),l.target.position.copy(t),l.target.updateMatrixWorld()}let _=new $d(n);_.setPixelRatio(n.getPixelRatio()),_.addPass(new ef(t,r));let v=new nf(e.perf.mobile?new G(Math.round(window.innerWidth/2),Math.round(window.innerHeight/2)):new G(window.innerWidth,window.innerHeight),.42,.38,3);e.params.bloom!==`0`&&e.perf.bloom&&_.addPass(v),_.addPass(new lf);let y=new Xd({name:`SiloGrade`,uniforms:{tDiffuse:{value:null},uAmount:{value:.55}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
      ...
      void main() {
        ...
        col = mix(col, sCurve, uAmount * 0.3);
        float shadowM = 1.0 - smoothstep(0.0, 0.45, lum);
        float hiM = smoothstep(0.55, 1.0, lum);
        col *= mix(vec3(1.0), vec3(0.88, 1.0, 0.98), shadowM * uAmount * 0.5);
        col *= mix(vec3(1.0), vec3(1.05, 1.0, 0.94), hiM * uAmount * 0.5);
        float d = distance(vUv, vec2(0.5, 0.48));
        col *= 1.0 - smoothstep(0.45, 0.95, d) * 0.32 * uAmount;
        gl_FragColor = vec4(col, tex.a);
      }`});return _.addPass(y),e.perf.mobile||_.addPass(new sf),e.onResize=(e,t)=>{_.setSize(e,t),v.setSize(e,t)},e.render=e=>{g(),_.render(e)},i.depthShade=e=>.45+.55*wd(1+e/-bf.bottom,0,1),i.setSilo=(t,{animate:n=!0,duration:r=2.5}={})=>{let a=kf[t];if(!a)return Promise.resolve();let o={...i.settings};return i.current=t,n?e.tweens.add({duration:r,onUpdate:e=>{let t={};for(let n of Object.keys(a))t[n]=typeof a[n]==`number`?Td(o[n],a[n],e):`#`+new Y(o[n]).lerp(new Y(a[n]),e).getHexString();i.settings=t,f(t)}}):(i.settings={...a},f(i.settings),Promise.resolve())},i.key=s,i.hemi=o,i.fill=l,i.sky=a,i.composer=_,i.bloom=v,i.grade=y,i.emissiveScale=1,f(i.settings),e.env=i,e.silo.onChange(t=>{t!==i.current&&i.setSilo(t,{animate:e.ready})}),i}var jf=`west`,Mf=`east`,Nf=47;function Pf(e,t,n,r,i,a={}){let o=n===jf?180:360-r,s=n===jf?180+r:360,c=n===jf?-1:1,l=a.y0??$(t),u=a.y1??vf(t),d=u-l;return{id:e,level:t,side:n,span:r,owner:i,kind:`room`,a0:o*wf,a1:s*wf,a0deg:o,a1deg:s,y0:l,y1:u,anchor:[c*Nf,l+Math.min(d*.55,4),0],cam:a.cam||{position:[c*(Nf-10),l+Math.min(d*.7,6.5),22+r*.22],target:[c*(Nf+2),l+Math.min(d*.4,2.6),-13]},modes:a.modes||[`18`,`17`],...a}}function Ff(e,t,n,r,i,a={}){return{id:e,level:t,owner:n,kind:`spot`,anchor:r,cam:i,modes:[`18`,`17`],...a}}var If=[Ff(`surface`,0,`surface`,[-24,2.5,-2.5],{position:[16,15,38],target:[-30,2,-12]}),Pf(`cafeteria`,1,Mf,60,`rooms/top`),Pf(`sheriff`,1,jf,45,`rooms/top`),Ff(`airlock`,1,`rooms/top`,[-44,$(1)+2.4,-2.5],{position:[-30,$(1)+7,26],target:[-40,$(1)+3,-2.5]}),Pf(`judicial`,14,jf,40,`rooms/top`,{cam:{position:[-36,$(14)+4.2,20],target:[-42,$(14)+2.4,-10]}}),Pf(`it`,19,Mf,60,`rooms/top`),Pf(`watcher`,20,jf,30,`rooms/top`),Pf(`camp`,18,jf,35,`silo17`,{modes:[`17`],cam:{position:[-36,$(18)+6.5,30],target:[-45,$(18)+1.6,-12]}}),Pf(`filtration`,55,jf,40,`rooms/mids`),Pf(`medical`,62,Mf,40,`rooms/mids`),Pf(`gardens`,66,jf,45,`rooms/mids`),Pf(`market`,68,Mf,60,`rooms/mids`),Pf(`mines`,70,jf,40,`rooms/mids`,{cam:{position:[-58,$(70)+6,30],target:[-63,$(70)+2.2,-10]}}),Pf(`farms`,73,Mf,70,`rooms/mids`),Pf(`midscafe`,75,jf,45,`rooms/mids`,{cam:{position:[-38,$(75)+2.6,24],target:[-51,$(75)+5.4,-9]}}),Ff(`gap`,91,`shaft`,[0,$(91)+6,0],{position:[38,$(90)+14,52],target:[0,$(91)+4,0]}),Pf(`supply`,110,jf,40,`rooms/deep`),Pf(`barricade`,130,Mf,25,`rooms/deep`),Pf(`juliette`,140,jf,25,`rooms/deep`),Pf(`walker`,144,Mf,45,`rooms/deep`),Ff(`mechcafe`,144,`rooms/deep`,[52,$(144)+3,-6],{position:[44,$(144)+5.4,9],target:[56,$(144)+2.6,-14]}),Pf(`generator`,145,jf,70,`rooms/deep`,{y0:bf.genFloor,y1:bf.bottomSlab,cam:{position:[-40,bf.genFloor+22,78],target:[-45,bf.genFloor+12,-16]}}),Ff(`digger`,147,`rooms/deep`,[0,bf.voidFloor+18,0],{position:[60,bf.voidFloor+40,150],target:[0,bf.voidFloor+16,-10]},{y0:bf.voidFloor,y1:bf.capBottom})],Lf=Object.fromEntries(If.map(e=>[e.id,e]));function Rf(e=null){return If.filter(t=>t.kind===`room`&&(!e||t.owner===e))}var zf={"surface": {"name": "地表", "short": "地表", "sub": "洼地、坡道与山脊上的枯树", "body": "佐治亚州荒芜的农田上，土堤围出一处洼地，五十座地堡之一就藏在下面。清洁者从气闸沿坡道走出，擦净传感器镜头，再向坡顶唯一的枯树走去。艾莉森和霍尔斯顿先后倒在那片坡地上，食堂里的人都能看见。越过山脊，头盔中绿色的谎言消失，真实世界显露出来：褐色大地、亚特兰大的废墟天际线，以及一座又一座埋在地下的地堡。", "facts": ["共有五十座地堡：1 号位于中央，周围分布着七组、每组七座地堡。（第3季第8集）", "设计可承受两英里外的三千万吨级爆炸；防爆门重 25 吨，过滤精度达 50 纳米。", "墙屏展示真实的外界，头盔里却是循环影像，飞鸟会重复出现。（第1季第10集）", "朱丽叶把警徽放在霍尔斯顿身上，随后越过山脊。（第1季第10集）", "17 号地堡是最近的邻居，步行不远便能到达，门外堆着数千具骸骨。", "第3季第9集：前所未有的人群看着一名男子不穿防护服走向外界。"], "episodes": "第1季第1集、第1季第2集、第1季第10集、第2季第10集、第3季第9集"}, "cafeteria": {"name": "食堂与墙屏", "short": "食堂 · 墙屏", "sub": "第 1 层——三座食堂中的第一座，也是观看清洁仪式的地方", "body": "这是地堡的门面：磨砂面板组成花瓣状穹顶，下面是一座圆形大厅。尽头唯一的“窗”是一块宽高比约五比一的长条墙屏，接收外部传感器传回的画面。人们在这里观看每一次清洁，山坡的光映在人们脸上。卢卡斯常在屏幕下彻夜描绘天空中的光点，却不知道它们叫作星星。", "facts": ["清洁仪式的观看资格通过抽签分配；放假两天，上层为来访者开放房间。", "信息技术部可以用“例行维护”为由关闭墙屏。（第2季第3集）", "第1季第3集 停电时，墙屏曾闪过一帧绿色画面，但无人察觉。", "第2季第10集：山脊上出现一个身影，食堂沸腾了——朱丽叶还活着。", "信息技术部的办公大厅和机械部食堂也使用相同的花瓣状穹顶。", "自由日的灯笼从外面的平台升起，沿竖井向上飘去。（第1季第1集）"], "episodes": "第1季第1集、第1季第3集、第1季第10集、第2季第2集、第2季第10集、第3季第9集"}, "sheriff": {"name": "警长办公室与气闸", "short": "警署 · 3 号拘留室", "sub": "第 1 层——先是 3 号拘留室，再是那扇门", "body": "穿过食堂、办公桌和黄铜警星，便是警长办公室、3 号拘留室，以及走廊尽头的气闸。只要说出那句话，《公约》就会把你带来这里。霍尔斯顿把自己锁进牢房，将钥匙扔到走廊里，对马恩斯说出了那句话。第一道门关闭，氩气雾涌入，第二道门向坡道打开；你离开后，火焰喷口会将身后的舱室彻底消毒。", "facts": ["“一旦走出气闸，你就不再受法律保护。”（第1季第2集）", "氩气携带会侵蚀隔热胶带的纳米机器人；信息技术部的胶带会失效，机械部的则能撑住。", "气闸由信息技术部控制，每次循环后会保持关闭 48 小时。（第3季第5集）", "第2季第10集：燃烧器点火时，朱丽叶和伯纳德都在舱内。", "霍尔斯顿留给继任者的提示：把镜子前的花增加一倍。（第1季第4集）", "清洁日，每隔十层就有一支消防队待命。（第1季第1集）"], "episodes": "第1季第1集、第1季第2集、第1季第10集、第2季第10集、第3季第5集"}, "airlock": {"name": "气闸与坡道", "short": "气闸 · 坡道", "sub": "第 1 层——唯一的出口", "body": "两道门之间，是每次清洁仪式的起点。内门密封后，氩气雾包围防护服；外门打开，露出通向地表的混凝土坡道。清洁者走出后，火焰会为身后的舱室消毒。坡道顶端，一扇沉重的钢门通向洼地，那里立着传感器，远处是长着枯树的山坡。", "facts": ["“一旦走出气闸，你就不再受法律保护。”（第1季第2集）", "雾气中的纳米机器人会侵蚀防护服的隔热胶带；信息技术部的胶带会失效，机械部的则能撑住。", "两扇滑动防爆门各重 25 吨，过滤器能阻挡小至 50 纳米的颗粒。（第3季第9集）", "信息技术部控制大门，每次循环后关闭 48 小时。（第3季第5集）", "第2季第10集：燃烧器点火时，朱丽叶和伯纳德都在气闸内。", "17 号的外门曾被尸体卡住；孩子们为两名来自 18 号的男子打开了它。（第3季第8集）"], "episodes": "第1季第1集、第1季第2集、第1季第10集、第2季第10集、第3季第5集、第3季第9集"}, "judicial": {"name": "司法部", "short": "司法部", "sub": "第 14 层——木饰面、黄铜与《公约》", "body": "这里是地堡最奢华的空间：木质墙板、黄铜灯具、俯瞰楼梯井的圆角窗，以及门口的两名探员。梅多斯法官的办公室、罗伯特·西姆斯的办公室都在这里。后面还有密封的遗物库，每件没收的遗物都会装袋并登记入册。詹斯在门外停下来喝水，却刻意没有敲门。", "facts": ["木材在地堡中十分稀缺，司法部的木饰面象征着地位。", "遗物登记册通过一个 PEZ 糖果盒和乔治的手表，将线索指向朱丽叶。（第1季第6集）", "第2季第4集：机械部代表团发现梅多斯死在椅子上——这是一场栽赃。", "一根外部管道通向这里，那就是“安全保障”，其中的毒物足以杀死所有人。（第2季第10集）", "上下两层都是住宅，一旦墙体被炸毁，数百人将面临危险。（第3季第7集）", "17 号地堡内，这根管道的检修盖板被人从里面焊死了。（第3季第8集）"], "episodes": "第1季第3集、第1季第6集、第2季第4集、第3季第7集、第3季第8集"}, "it": {"name": "信息技术部与密库", "short": "信息部 · 密库", "sub": "第 19 层——伯纳德的楼层，以及“传承”", "body": "花瓣状穹顶下排列着 CRT 终端，旁边是伯纳德的办公室、防护服室，以及上锁的服务器机房。H57 隔热胶带防止服务器过热。更深处，一扇圆形钢门通向密库，正式名称为“传承与算法室”。Y 形空间里存放着书籍和画作，还有一个只对信息技术部主管及其接班人说话的声音。这里的记录可追溯至 352 年前，再早一天也没有。", "facts": ["电力通过 1 号地堡的线路输入；机械部切断地堡供电时，信息技术部仍然明亮。（第2季第7集）", "“验证通过。欢迎，卢卡斯·凯尔。”传承会以姓名确认每位信息部接班人。（第2季第7集）", "只有两个人能读的《命令》规定：清洁失败时，准备战争。（第2季第2集）", "每座地堡有独立无线电频道，1 号地堡监听全部五十座。（第3季第5集）", "17 号密库的结构相同，却没有那个声音；索罗在里面生活了数十年。", "六座地堡曾被完全重置，这一座发生在 140 年前。（第3季第2集）"], "episodes": "第1季第3集、第1季第9集、第2季第2集、第2季第7集、第2季第10集、第3季第2集、第3季第6集"}, "watcher": {"name": "回收站与监控室", "short": "监控室", "sub": "第 20 层——镜子也在看着你", "body": "这是十二座回收站之一，也是地堡的五金商店。各站按错开的时间表，每小时向垃圾道倾倒一次废物。后方有一个清洁工储物间，里面却藏着一排排远超普通居民所能拥有的监视器。每间公寓的镜子都是镜头，西姆斯就站在这里看警长吃早餐。", "facts": ["十二座回收站各有不同的时间表，每小时倾倒一次。", "西姆斯在储物间向特朗布尔提出接班人的职位，随后把他推过栏杆。（第1季第5集）", "伯纳德在这里让朱丽叶看见乔治最后一分钟的影像：他坐上栏杆，松开了手。（第1季第10集）", "120 层以下的大多数摄像头被砸毁，信息部转而雇人窃听。（第2季第3集）", "第3季第6集：录像显示，格伦达在相隔十分钟内先后出现在矿区和物资部。", "遮住镜子、打开水龙头，是居民躲避监视与窃听的两种办法。"], "episodes": "第1季第4集、第1季第5集、第1季第6集、第1季第10集、第3季第6集"}, "camp": {"name": "幸存者之家", "short": "幸存者营地", "sub": "17 号地堡第 18 层——唯一亮灯楼层的上一层", "body": "吊床、种植床、自制风扇和门口的泛光灯，都接着下一层信息部的电源。奥黛丽、里克、霍普、本尼和婴儿苔丝住在靠近楼梯的角落，暗处的观察点能看见竖井和信息部。从外面几乎发现不了这里。他们看着朱丽叶到来，割断她的绳子，又扔下救了她的浮具。", "facts": ["奥黛丽割断绳子，里克扔下容器，两人随后躲藏了数周。（第2季第9集）", "食物严重短缺，他们只能吃老鼠。", "里克有护甲和斧头，霍普拿着钉头锤，奥黛丽使用弓。", "索罗在信息部桥上被绳套捕获后，被抬到这里。（第2季第7集—第8集）", "水面位于 22 与 23 层之间，比吊床低四层。", "第3季第8集：孩子们为两名来自 18 号地堡的男子打开了气闸。"], "episodes": "第2季第8集、第2季第9集、第2季第10集、第3季第8集"}, "filtration": {"name": "净水设施", "short": "净水设施", "sub": "第 55 层——渗透过滤厂", "body": "这里的渗透过滤系统负责净化地堡用水，位于医疗层上方七层的平台后面，后来成了守卫最严密的一扇门。搬运工连续数日把标着“维生素 D+”的桶送到这里，才有人开始追问原因。从药剂投入的那一刻起，整座地堡都在喝下让自己遗忘的水。", "facts": ["“信息技术部检测到维生素 D 水平偏低，需要向供水中添加补充剂。”", "投药前必须关闭渗透系统。", "西姆斯的建议是喝牛奶、果汁或葡萄酒，绝不能喝自来水。", "第3季第9集：诺克斯和雪莉带领人群来到这里，突击队举起武器，朱丽叶出面化解对峙。", "此处不同于楼梯标牌上第 71 层附近的农业过滤区。", "地下水泵让地堡保持干燥：18 号的泵位于 90 层，17 号的泵位于 30 和 144 层。"], "episodes": "第3季第3集、第3季第6集、第3季第7集、第3季第9集"}, "medical": {"name": "中层医疗区", "short": "医疗区", "sub": "第 62 层——从育婴室到停尸房", "body": "灰绿色墙面、带护笼的灯泡、钢制柜子，以及穿白衣的工作人员。楼梯标牌列出新生儿科、育婴室、A 至 D 病区、隔离区、综合征治疗、外科、精神科等部门，还包括长期护理和停尸房。育婴室是摄像头的盲区，皮特把格洛丽亚推到这里，让她有一个小时重新找回自己。", "facts": ["霍尔斯顿把乔治的硬盘藏在格洛丽亚的通风口里，并在镜子前放上花。（第1季第7集）", "肯尼迪说：“我一直在 62 层做检查。”（第1季第5集）", "离开父亲去机械部二十年后，朱丽叶再次停在父亲门前。（第1季第4集）", "皮特曾奉命假装取出上百枚避孕植入物，但为菲比做了真正的手术。（第2季第3集）", "奥拉·肯特的遗体躺在 62 层停尸房。（第3季第5集）", "标牌上共列出十五个部门，从新生儿科到精神科。"], "episodes": "第1季第3集、第1季第4集、第1季第5集、第1季第7集、第1季第8集、第2季第3集、第3季第5集"}, "gardens": {"name": "花园", "short": "花园", "sub": "第 66 层——静思、纪念与玻璃温室", "body": "中层区域的一整层绿意：标牌列着静思区、纪念区、水景花园、玻璃温室，以及一个看起来像礼拜堂的地方。植物灯下，层层露台围绕巨大的混凝土柱展开，树木间摆着长椅和桌子。这里几乎可以确定就是詹斯和马恩斯漫长下行途中吃草莓的公园。", "facts": ["西姆斯送来“梅多斯法官的草莓”；在地堡中，水果本身就是一种信息。（第1季第3集）", "卡拉和沃克在代表团上行途中，坐在公园长椅上休息。（第2季第4集）", "皮特在长椅上与菲比见面，盼望抽签成功。（第2季第3集）", "制作设计师定下的规则：地堡中的每一盏灯都是植物生长灯。", "死者会在农场中化为肥料，让活着的人有食物可吃。"], "episodes": "第1季第3集、第2季第3集、第2季第4集"}, "market": {"name": "集市", "short": "集市", "sub": "第 68 层——140 个摊位", "body": "狭窄巷道像旧时的巴塞罗那：圆拱门、舷窗、篷布遮阳棚，食品摊上方挂着红色搪瓷吊灯，节日期间还会拉起彩旗和灯串。1 至 140 号摊位分布在各个区块里，经营食品、纸张、五金和宠物用品，旁边还有仓库。乔治·威尔金斯曾在这里修电脑，艾莉森为维修他的终端，走下了将近七十层。", "facts": ["“你是走了七十层才累，还是……本来就累？”（第1季第1集）", "第3季第2集：“局外人”在储藏室与朱丽叶见面，随后从墙内的通道消失。", "少年粉丝模仿朱丽叶的穿着，还有工匠出售警长徽章。（第3季第1集、第3季第5集）", "这里使用信用点；伯纳德演讲后，每户得到五个信用点。（第2季第2集）", "楼梯标牌写的是“集市 68”，并非常被误读的 73。"], "episodes": "第1季第1集、第3季第2集、第3季第5集"}, "mines": {"name": "矿区", "short": "矿区", "sub": "第 70 层——铁矿，也是地堡的监狱", "body": "爆破形成的岩壁、木支架、悬挂电缆，以及沿洞顶排列的暖色工作灯。矿区为地堡提供铁矿，也接收囚犯：入口之后没有灯，没有摄像头，死去矿工的肺里尽是粉尘。矿道已经开凿了三百年，《公约》却规定每条横向支巷不得超过 200 英尺，防止有人挖向邻近地堡。", "facts": ["“在矿里，你看不到灯光。”卢卡斯被判十年，后来减为五年。（第1季第10集、第2季第4集）", "矿区主管埃德·哈伍德报告，戴维支井的 B-92 支巷发生坍塌。（第3季第1集）", "格伦达·哈伍德住在 70 层，也就是矿区。（第3季第4集）", "第3季第3集：没有警报，灭鼠药就被泵入矿道；卢卡斯已经在这里躲了数月。", "奥拉·肯特并非死于毒气，而是被钢筋击打后扔进废弃矿道。（第3季第4集）", "有某种通道能让人比走楼梯更快地穿行地堡。（第3季第6集）"], "episodes": "第1季第10集、第2季第4集、第3季第1集、第3季第3集、第3季第4集、第3季第6集"}, "farms": {"name": "农场", "short": "农场", "sub": "第 73 层——洋红色灯光下的果园与玉米田", "body": "标牌上的环形目录像一份菜单：粮仓与磨坊、果树、水培、水产养殖、乳业、冷藏、耕地、谷物、饲料库与畜牧。红紫色植物灯下，苹果树和一行行玉米围着巨柱生长，地面覆着苔藓。温室与林木大厅继续向下延伸至八十多层；80 层的副警长报告，从那里直到农场都平安无事。", "facts": ["这里产出草莓、桃子、兔、猪、鸡和鸡蛋；格洛丽亚在医疗区吃到了培根。（第1季第7集）", "死者被埋入土中作为肥料，詹斯和马恩斯安葬在这里。（第1季第5集）", "卡米尔把诺克斯和雪莉藏在 73 层的一处隐蔽空间。（第2季第5集）", "植物灯泡是地堡的倒计时：二十年前还有七十年的库存，如今只剩两年。（第3季第5集）", "122 层还有一座农场，因此机械部把路障向上推进了十层。（第2季第6集）", "伯纳德带朱丽叶走进田地，说出了她从未提过的词——“硬盘”。（第1季第8集）"], "episodes": "第1季第3集、第1季第5集、第1季第8集、第2季第5集、第3季第5集"}, "midscafe": {"name": "中层食堂", "short": "中层食堂", "sub": "第 75 层——中层副警署所在楼层", "body": "每个区域都有食堂，每座食堂都有墙屏。相同的传感器传来同一片死寂山坡，供那些永远不会爬到第 1 层的人观看。中层食堂与中层副警署共用一层，这里曾是马恩斯的辖区，上下各二十五层。叛乱期间，副警长们搬走桌子，把这里改成临时拘留区。", "facts": ["马恩斯说，自己过去的辖区是中层副警署上下各二十五层。（第1季第4集）", "第2季第9集：所有副警长被调往这一层的食堂，这里成为临时拘留室。", "三座食堂分别位于第 1 层、中层，以及第 144 层机械部，各有一块墙屏。", "花瓣状穹顶与第 1 层和信息部相同，实际是同一布景经重新装饰。", "第 75 层是估计值，剧中从未在门上明确标出层数。"], "episodes": "第1季第4集、第2季第9集"}, "mechcafe": {"name": "机械部食堂", "short": "机械部食堂", "sub": "第 144 层——深层区域看向外界的墙屏", "body": "沃克工坊后面，穿过印着模板字样的走廊，机械部居民在自己的花瓣状穹顶和墙屏下用餐。这是在地下约一英里处、第三个也是最后一个观看荒山的地方。深层居民在这里庆祝、悼念和争论，几步之外就是停尸房。", "facts": ["每座食堂都有墙屏，信息部在 19 层控制全部三块屏幕。", "这里举办聚会和守灵，是深层区域唯一的大型公共房间。", "停尸房也在同一层，乔治的遗体曾被送到这里。（第1季第1集）", "第3季第3集：叛乱后，旁边循环风机上方的尸体堆了三层。"], "episodes": "第1季第1集、第1季第2集、第3季第3集"}, "gap": {"name": "断层", "short": "断层", "sub": "第 90—92 层——被皮特炸毁的楼梯", "body": "“92 到 90 层之间的楼梯，就这么没了。”皮特·尼科尔斯把炸弹放在担架上抬上楼，途中丢了计时器。他让汉克带着朱丽叶的手表先走，自己手动引爆，将突击队困在缺口下方。三个月后，这里被称作“断层”：绳索和脚手架横跨深井，雪莉的队伍一圈圈重建楼梯，奥西的滑轮座椅则成为 143 年来第一部合法升降装置。", "facts": ["第三季中，“去断层下面”就意味着进入深层区域。", "钢筋短缺，楼梯恐怕要到孙辈时代才能修好。（第3季第2集）", "滑轮总是卡住。（第3季第4集）", "90 层水泵是伯纳德用来诱使沃克落入陷阱的诱饵。（第2季第8集）", "爆炸前，诺克斯和雪莉曾伪装成搬运工经过 92 层。（第2季第5集）", "第3季第9集：一个早已被地堡安葬的人乘座椅上来投降，还给了奥西小费。"], "episodes": "第2季第5集、第2季第8集、第2季第10集、第3季第1集、第3季第4集、第3季第9集"}, "supply": {"name": "物资部", "short": "物资部", "sub": "第 110 层——货位、高架运输线与关键物资库", "body": "箱子从高架运输线上卸入货位，库房由狗看守，卡拉·麦克莱恩一直管理这里，直到退休。西姆斯在此部署了五十名突击队员，拦截机械部代表团。三道锁后藏着关键物资库，存放创始者留下、地堡无法制造的有限物资，包括防护服面料和灯泡。而箱子里的东西，比账面上记载的更少。", "facts": ["“我在 110 层部署了五十名突击队员。”——西姆斯（第2季第4集）", "领取关键物资需要主管或接班人在场，每件物品需三项批准。（第2季第3集）", "灯泡库存在二十年前可用七十年，三个月前可用五十年，如今只剩两年。（第3季第5集）", "农场灯泡耗尽，食物就会消失，这是卡拉所说的黑暗死亡倒计时。", "沃克从 144 层爬到这里，寻找救下朱丽叶的隔热胶带。（第1季第10集）", "物资部接班人奥拉·肯特正在调查物资失窃。（第3季第1集—第5集）"], "episodes": "第1季第10集、第2季第3集、第2季第4集、第3季第5集、第3季第8集"}, "barricade": {"name": "路障", "short": "130 层路障", "sub": "第 130 层——机械部的前线", "body": "司法部奉伯纳德之命封锁 130 层楼梯，机械部的物资供应随即中断。一个正常社会距离混乱，也许只差九顿没吃上的饭。钢板、喷字门、上方的突击队，以及下方呼喊的深层居民构成前线。诺克斯和雪莉把偷来的绞盘挂到栏杆上，牵着手从旁边降下。几天后，混凝土切割锯从突击队身后的地板钻出，战线推进到了 120 层。", "facts": ["一个下午推进十层，并夺得 122 层农场，伯纳德再也无法让他们挨饿。", "“我住在 132 层。”桑迪在离家两层的地方被拦下。（第2季第5集）", "122 层农民从垃圾道送来食物，纸条上写着“朱丽叶还活着”。（第2季第6集）", "皮特和凯瑟琳利用婴儿与假剖宫产手术蒙混过关。（第2季第6集）", "120 层的门上喷着白字，下方墙面布满“JL”涂鸦。", "卡米尔后来承认，她帮助上移路障，是为了让他们拥有农场。（第3季第9集）"], "episodes": "第2季第5集、第2季第6集、第2季第9集、第3季第9集"}, "juliette": {"name": "朱丽叶的公寓", "short": "朱丽叶的公寓", "sub": "第 140 层——门牌、床与工作台", "body": "印着 140 的门后，是一张床和狭小的起居空间。某天夜里，乔治的包裹等在床上，里面有一件遗物和撕成两半的纸条。她给霍尔斯顿看了一半，留下另一半：“记住你最后一次在哪里见过它，我找到了我要找的东西。”地板开始嗡鸣时，雪莉在这条走廊找到宿醉的她，她又戴上了乔治的手表。", "facts": ["十三岁时，她拿着伪造的父亲便条，独自走到这里。（第1季第4集）", "乔治的手表是登记在册的遗物，西姆斯在司法部看见它戴在她腕上。（第1季第6集）", "嗡鸣来自积累了三十年问题的弯曲转子叶片。（第1季第3集）", "140 层既是她家门口，也是机械部的上缘；下面属于深层居民自己的世界。"], "episodes": "第1季第2集、第1季第3集、第1季第4集"}, "walker": {"name": "沃克的工坊", "short": "沃克的工坊", "sub": "第 144 层——楼梯的终点", "body": "楼梯终止于加宽的圆形平台，地面涂着 144，四周是带护笼的循环风机。玛莎·沃克的电子工坊就开在旁边。住所、工作台与无线电都在一间房里，她已有二十五年没有跨出门槛。垃圾运输线上最好的东西都送到这里，叛乱时，所有重要人物也会来到这里。", "facts": ["“她已经二十五年没出门了。”直到她爬上物资部寻找隔热胶带。（第1季第10集）", "沃克认出遗物是一台摄像机，并追问《公约》为何禁止升降机和放大镜。（第1季第5集）", "她故意开启摄像头三十秒，向伯纳德传递信息。（第2季第7集）", "第2季第10集：在这里大声说出的话都是给伯纳德摄像头听的，真正的计划藏在手中。", "第3季第3集：叛乱后，144 层循环风机上方的尸体堆了三层。", "144 层还有工具制造间、机械部食堂、焚化炉和乔治最后的住所。"], "episodes": "第1季第2集、第1季第5集、第1季第10集、第2季第7集、第2季第10集、第3季第5集、第3季第6集"}, "generator": {"name": "发电机", "short": "发电机", "sub": "144 层以下——数层楼高的蒸汽轮机", "body": "黑暗的栈桥环绕着汽轮机塔，橙色光从舷窗中透出，控制室俯瞰整个大厅。噪声大到喊叫也无用，只能用手势交流。蒸汽沿管道上升，转过弯后进入轮机。主阀一旦关闭，距离压力超过红线就只剩约三十分钟。朱丽叶和库珀悬在转子上，争分夺秒地拔出弯曲叶片。", "facts": ["“蒸汽来自很深很深的地方，没有人知道具体在哪里。”（第1季第3集）", "备用机组只能提供最低限度电力；首次八小时停电从晚上十点开始。（第1季第3集）", "朱丽叶带着水管爬进压力舱，在水不断涌入时仍留在里面。（第1季第3集）", "从竖井落下的红球，是通知泰迪切断地堡电力的信号。（第2季第4集）", "第2季第10集：突击队发现发电机上接着引线，却没有雷管。", "机械部负责让灯亮着，也有能力让它们全部熄灭。"], "episodes": "第1季第1集、第1季第3集、第2季第4集、第2季第10集、第3季第3集"}, "digger": {"name": "掘进机洞窟", "short": "掘进机", "sub": "三十英尺混凝土封盖之下——创始者的掘进机", "body": "最底层楼板下，岩石打开成与地堡同宽的洞窟。地面有浅水，挖出这座深井的机器仍立在那里：数层楼高的中央塔，八条机械臂，每条装着三个钻头，固定在环形栈桥上。把它从一英里深的井中吊上去，比就地遗弃更昂贵，所以创始者用三十英尺厚的混凝土把它封住。乔治在机器上搭建了自己的遗物营地。", "facts": ["蓝图标注：SBM、AIP——地堡掘进机，就地废弃。", "上百盏工作灯中只有少数仍亮着，没人能查明它们的电源。", "一条隧道通向圆形钢门，门后的声音说出了奎因、梅多斯和威尔金斯的名字。（第2季第9集）", "叛乱后沃克封住了洞窟，但封条只是做做样子。（第3季第4集）", "十台掘进机各建五座地堡，就地遗弃让工程节省了五年。（第3季第8集）", "朱丽叶寻找乔治所说的门时，把灯掉进了淹水隧道。（第1季第2集）"], "episodes": "第1季第2集、第1季第5集、第2季第4集、第2季第9集、第3季第4集、第3季第8集"}, "stair": {"name": "中央大楼梯", "short": "中央大楼梯", "sub": "144 层，超过一公里的混凝土螺旋", "body": "一条混凝土楼梯环绕实心中央柱，从食堂平台一直通向 144 层。楼梯宽四米，带矮墙和钢管扶手，模型中每层旋转两圈。每层伸出三座相隔 120 度的桥，与上一层错开，抬头看去，竖井像一条 DNA 链。每座桥旁的深色标牌印着层数，以及像地铁线路图一样的下方地点示意。", "facts": ["没有电梯，没有滑轮，《公约》要求所有人步行；黎明前楼梯属于搬运工。", "七十多岁的市长走下全部 144 层再走回去，水壶里却装着毒物。（第1季第3集）", "自由日，灯笼在井中升起，孩子们沿栏杆滑行。（第1季第1集）", "第2季第7集：传单飘落到每个平台，随后除了信息部，所有灯都熄灭了。", "每隔三十层安装一个信号增强器，126 层也有一个。（第1季第10集）", "140 年前，地堡在楼梯井间挂起网，接住跳下去的人。（第3季第7集）"], "episodes": "第1季第1集、第1季第3集、第1季第10集、第2季第5集、第2季第7集、第2季第10集"}, "silo17": {"name": "17 号地堡", "short": "17 号地堡", "sub": "被水淹没的邻居——相同图纸，反向布局", "body": "山丘另一侧同样有 144 层，只是镜像转向，已经黑暗了三十多年。罗恩·塔克拒绝清洁，在镜头上写下“谎言”后离开视野。居民追随他走出地堡，数千具骸骨至今围在门口。司法部为淹没机械部，炸毁了 144 层地下水泵。发电机沉入水下，水面逐渐升到 23 层下方，如今只有信息部仍有灯光。", "facts": ["水位处于 22 与 23 层之间；朱丽叶启动的水泵在 30 层，位于水下八层。", "信息部炸毁了连接楼梯的桥，人们先用绳索、再用木板，最后架起临时桥。", "索罗住在密库中，入口有舱门和四位密码，输错三次就会锁定。", "农场只剩一棵活树，旁边有两盏灯和一条滴水管。", "这里庆祝的是创始者日而非自由日，还有桃子罐头和摆着簧风琴的教室。", "两名来自 18 号的男子在无人机攻击下，于夜间抵达气闸。（第3季第7集—第8集）"], "episodes": "第2季第1集、第2季第3集、第2季第7集、第2季第9集、第2季第10集、第3季第8集"}, "pact": {"name": "《公约》", "short": "《公约》", "sub": "创始者的法律——供五百年共同生活使用的一本书", "body": "《创始者与地堡居民之间的公约》是地堡唯一拥有的历史。居民每晚阅读它，对它宣誓，孩子们在学校比赛背诵。要求出去，就必须出去，不能反悔。禁止电梯和滑轮，禁止高倍率放大镜、遗物、居民无线电、未经批准的亲密关系，以及超过 200 英尺的隧道。没有人知道原因。", "facts": ["市长去世后，信息技术部主管成为代理市长。（第1季第4集）", "沃克的两个疑问：为什么禁止电梯，为什么禁止放大镜？（第1季第5集）", "法官可因三项理由被弹劾，公约中还有涉及母亲身份的条款。（第2季第4集—第5集）", "奎因那本已有 140 年历史的《公约》，是解开他密码的钥匙。（第2季第8集）", "第三季中，保罗·比林斯正为新成立的地堡议会重写它。", "作者们将它描述为一本指导共同生活五百年的书。（第3季第9集）"], "episodes": "第1季第1集、第1季第5集、第2季第4集、第2季第8集、第3季第1集、第3季第9集"}, "cleaning": {"name": "清洁仪式", "short": "清洁仪式", "sub": "说出那句话，穿上防护服，擦净镜头", "body": "任何说出“我想出去”的人都必须出去：先进入 3 号拘留室，再穿上手腕和脚踝用 H57 隔热胶带密封的白色防护服，腰间小袋装着羊毛擦拭垫，戴上内置屏幕的头盔。然后依次经过气闸、坡道和山丘。头盔展示绿草与飞鸟，清洁者确信地堡一直被欺骗，于是擦净镜头，希望让大家看见真相，却在抵达坡顶之前倒下。每一次都如此，直到朱丽叶出现。", "facts": ["霍尔斯顿与艾莉森并肩躺在山坡上，朱丽叶把警徽放在他身上。", "深层居民下注十个信用点，赌他能否撑过三分钟。（第1季第2集）", "信息部故意提供劣质胶带，机械部的胶带让朱丽叶走过山脊。", "头盔中的飞鸟影像不断重复，她曾在硬盘上见过同样的画面。", "简·卡莫迪在地堡纪元 97 年执行清洁，她的视频展示了绿色世界。", "17 号的罗恩·塔克没有清洁，而是在灰尘中写下“谎言”。"], "episodes": "第1季第1集、第1季第2集、第1季第10集、第2季第3集、第3季第9集"}, "population": {"name": "人口", "short": "人口", "sub": "10,112 人，一场抽签，每人一枚植入物", "body": "最近一次统计共有 10,112 人，其中 5,496 人不到 46 岁，每层约有 86 套公寓。每个居民的髋部上方深处都植有避孕胶囊，抽签成功后可取出一年。但如果档案被标为橙色代码，医生就只是假装取出。艾莉森曾用刀挖出自己的胶囊，证明这一点。", "facts": ["人口从 第1季第5集 的 10,112 人，降到算法在 第3季第3集 计算的约 9,913 人。", "每次清洁后会追加一次抽签，候选人来自同一名单。（第2季第3集）", "每年发放二十五条出生毯，每十个孩子一条，意味着约 250 名新生儿。（第1季第2集）", "第三次也是最后一次尝试机会，大约在 38 岁。（第1季第1集）", "140 年前上一次遗忘事件中，两千人死亡。（第3季第7集）"], "episodes": "第1季第1集、第1季第5集、第2季第3集、第2季第5集、第3季第3集"}, "power": {"name": "电力", "short": "电力", "sub": "一台汽轮机、一套备用机组，以及来自 1 号的线路", "body": "电力来自 144 层下方的一台蒸汽轮机，以及仅能维持最低用电的备用机组，再由信息部服务器分配给照明、水泵、通风和屏幕。灯光模拟昼夜循环。地堡历史上第一次宣布的停电从晚上十点开始，持续八小时。机械部只需一个信号，就能让地堡陷入黑暗，这也是每次叛乱都会被归咎于机械部的原因。", "facts": ["信息部的电力线路来自 1 号地堡，因此发电机停转后它仍有灯光。（第3季第6集）", "每座地堡都有两条外部线路：电力通向信息部，“安全保障”通向司法部。", "H57 隔热胶带防止服务器过热，也用于密封防护服。", "17 号的发电机沉在上百层深的水下，信息部却依然亮着。", "每盏灯都是植物生长灯，而灯泡库存正在耗尽。"], "episodes": "第1季第3集、第1季第7集、第2季第4集、第2季第7集、第3季第6集"}, "water": {"name": "供水", "short": "供水", "sub": "下方的水泵，与 55 层的渗透过滤厂", "body": "地堡位于地下水位以下，地下水泵必须昼夜运转以维持干燥。18 号在 90 层设有水泵，17 号则在 30 和 144 层。55 层净水设施通过渗透过滤净化水，再送往水龙头，市长的账簿记录着每年的用水量。炸毁水泵，地堡就会从底部被淹没；向净水厂投药，地堡就会遗忘。", "facts": ["突击队炸毁 17 号的 144 层水泵，三十年间水面升高了上百层。", "水壶中的灭鼠药杀死了詹斯市长，漏水却让马恩斯躲过一劫。（第1季第4集）", "水泵维修优先于一切，这张工单把沃克引入陷阱。（第2季第8集）", "维生素 D+ 在 55 层被加入供水系统。（第3季第6集）", "汽轮机所需蒸汽来自深处，至今没人找到它的源头。"], "episodes": "第1季第4集、第2季第5集、第2季第7集、第2季第8集、第3季第6集、第3季第9集"}},Bf=[[1,1,`食堂 · 警署 · 气闸`,`#d9d2c5`,`#a67c3a`],[2,13,`上层公寓`,`#c9a66b`,`#3f7a78`],[14,15,`司法部`,`#8b2e2e`,`#6b4a2f`],[16,18,`上层公寓`,`#c9a66b`,`#3f7a78`],[19,19,`信息部`,`#2f5d8a`,`#6f7478`],[20,20,`回收站`,`#3e8e7e`,`#3f7a78`],[21,49,`上层公寓`,`#c9a66b`,`#3f7a78`],[50,50,`中层医疗区（诊所）`,`#a9d8c8`,`#5f7a4a`],[51,54,`中层公寓`,`#9aa3ad`,`#3f7a78`],[55,55,`净水设施`,`#2fa5c0`,`#3f7a78`],[56,61,`中层区 · 磨坊 · 回收站`,`#9aa3ad`,`#5f7a4a`],[62,62,`中层医疗区`,`#a9d8c8`,`#5f7a4a`],[63,65,`中层公寓`,`#9aa3ad`,`#3f7a78`],[66,66,`花园`,`#5e9e7a`,`#5f7a4a`],[67,67,`中层公寓`,`#9aa3ad`,`#3f7a78`],[68,68,`集市`,`#c9a227`,`#a67c3a`],[69,69,`附属区`,`#9aa3ad`,`#3f7a78`],[70,70,`矿区入口`,`#7a5c2e`,`#a67c3a`],[71,72,`水培 · 过滤`,`#8fbf8f`,`#5f7a4a`],[73,79,`农场`,`#4f8a3c`,`#5f7a4a`],[80,89,`温室 · 工坊 · 85 层安宁疗护`,`#9aa3ad`,`#5f7a4a`],[90,92,`断层`,`#e0b400`,`#a67c3a`],[93,104,`中层下部公寓`,`#9aa3ad`,`#3f7a78`],[105,105,`副警署`,`#a8743a`,`#6b4a2f`],[106,119,`物资部`,`#6e7b3a`,`#5f7a4a`],[120,124,`中层下部农场 · 120 层路障`,`#4f8a3c`,`#5f7a4a`],[125,139,`机械部（上部）`,`#c8781e`,`#a67c3a`],[140,143,`机械部`,`#c8781e`,`#a67c3a`],[144,144,`机械部核心 · 沃克`,`#9e5a10`,`#a67c3a`]];function Vf(e){let t=Bf.find(([t,n])=>e>=t&&e<=n)||Bf[Bf.length-1];return{dept:t[2],color:t[3],paint:t[4]}}var Hf={1:`食堂 · 警署`,2:`上层公寓`,3:`上层公寓`,4:`上层公寓`,5:`上层公寓`,6:`警长的公寓`,7:`上层公寓`,8:`上层公寓`,9:`马恩斯的公寓`,10:`搬运调度站`,11:`上层公寓`,12:`上层公寓`,13:`住宅区 · 司法部上方`,14:`司法部`,15:`主管住宅区`,16:`住宅区 · 司法部下方`,17:`西姆斯一家 · 格洛丽亚的公寓`,18:`上层公寓`,19:`信息部 · 密库`,20:`回收站 · 监控室`,21:`上层公寓`,22:`肯尼迪的公寓`,23:`上层公寓`,24:`上层公寓`,25:`上层公寓`,26:`26 层酒吧`,27:`上层公寓`,28:`上层公寓`,29:`查尔斯·马丁的公寓`,30:`司法部检查站`,31:`里贾娜·杰克逊的公寓`,32:`上层公寓`,33:`上层公寓`,34:`上层公寓`,35:`上层公寓`,36:`特朗布尔的公寓`,37:`上层公寓`,38:`上层公寓`,39:`上层公寓`,40:`上层公寓`,41:`上层公寓`,42:`乔治的公寓（叛乱后 126 年）`,43:`上层公寓`,44:`上层公寓`,45:`弗兰基·布朗的公寓`,46:`上层公寓`,47:`上层公寓`,48:`上层公寓`,49:`上层公寓`,50:`中层起点 · 诊所`,51:`中层活动区`,52:`中层公寓`,53:`中层公寓`,54:`制造区 1`,55:`净水设施`,56:`制造区 2 · 学校`,57:`附属区 1`,58:`附属区 2`,59:`磨坊`,60:`医疗物资`,61:`回收站`,62:`中层医疗区`,63:`中层公寓`,64:`附属区`,65:`MC · 中层公寓`,66:`花园`,67:`附属区`,68:`集市`,69:`附属区`,70:`矿区入口 · 咖啡馆`,71:`过滤 · 水培`,72:`中层公寓 · 学校`,73:`农场`,74:`住宅 74/1—74/86`,75:`中层食堂 · 副警署`,76:`76 层泵房`,77:`温室 1`,78:`尼科尔斯一家`,79:`林木大厅 1`,80:`拉方丹的岗哨`,81:`林木大厅 2`,82:`温室 2`,83:`中层下部公寓`,84:`工坊 1`,85:`安宁疗护区`,86:`工坊 2`,87:`诺克斯与雪莉（第三季）`,88:`工坊 3`,89:`工坊 4`,90:`90 层水泵 · 断层`,91:`断层`,92:`断层`,93:`中层下部公寓`,94:`中层下部公寓`,95:`中层下部公寓`,96:`中层下部公寓`,97:`中层下部公寓`,98:`98 层的线人`,99:`中层下部公寓`,100:`中层下部公寓`,101:`中层下部公寓`,102:`中层下部公寓`,103:`中层下部公寓`,104:`中层下部公寓`,105:`105 层副警署`,106:`物资部附属区`,107:`物资部附属区`,108:`物资部`,109:`物资部`,110:`物资部 · 主层`,111:`物资部`,112:`物资部`,113:`物资部`,114:`物资部`,115:`物资部`,116:`物资部`,117:`物资部`,118:`物资部`,119:`物资部平台`,120:`120 层路障 · 栏杆`,121:`中层下部农场附属区`,122:`中层下部农场`,123:`机械部（上部）`,124:`卡拉·麦克莱恩的公寓`,125:`机械部（上部）`,126:`信号增强器 · 回收站`,127:`机械部（上部）`,128:`机械部（上部）`,129:`机械部（上部）`,130:`130 层路障`,131:`机械部（上部）`,132:`桑迪的家`,133:`机械部（上部）`,134:`机械部（上部）`,135:`住宅区`,136:`机械部（上部）`,137:`机械部（上部）`,138:`机械部（上部）`,139:`机械部（上部）`,140:`朱丽叶的公寓`,141:`机械部`,142:`机械部`,143:`机械部`,144:`沃克的工坊 · 风机`},Uf={"1": "霍尔斯顿把自己锁进 3 号拘留室，说出了《公约》绝不允许收回的那句话。（第1季第1集）", "2": "霍尔斯顿往返食堂与 6 层公寓时经过这里。（第1季第1集）", "4": "马恩斯下行途中经过的平台。（第1季第2集）", "6": "霍尔斯顿将花放在镜子前；关于乔治的档案藏在通风口里。（第1季第4集）", "8": "朱丽叶下行时经过的平台。（第1季第5集）", "9": "马恩斯在自己家门口，被自己的猎枪杀死。（第1季第4集—第5集）", "10": "地堡的每次配送都在这里登记，黎明前的楼梯属于搬运工。", "12": "詹斯与马恩斯在漫长的下行途中经过这里。（第1季第3集）", "13": "住宅层；司法部墙体若被炸毁，这里也会面临危险。（第3季第7集）", "14": "梅多斯的办公室、西姆斯的办公室、遗物库，以及盖板后面的“安全保障”管道。", "15": "主管住宅区：梅多斯的房间摆满遗物，还有《绿野仙踪》。（第1季第7集、第2季第2集）", "16": "住宅层；司法部墙体若被炸毁，这里也会面临危险。（第3季第7集）", "17": "格洛丽亚用流水声干扰窃听；朱丽叶在西姆斯的电脑上读取硬盘。（第1季第9集）", "18": "在 17 号地堡中，这里是幸存者之家，电源接自下一层的信息部。（第2季第9集）", "19": "伯纳德的办公室、机房和密库；唯一从 1 号地堡获得供电的楼层。", "20": "清洁工储物间后藏着监控室；西姆斯将特朗布尔推过栏杆。（第1季第5集）", "21": "在 17 号地堡中，这里有科尔·迈尔斯的公寓，是水面上最后一个干燥楼层。", "22": "帕特里克·肯尼迪的公寓；“所有突击队前往 22 层”，以及垃圾道逃生。（第1季第10集）", "23": "朱丽叶翻过栏杆，落在这里的桥上。（第1季第9集）在 17 号地堡中，这是第一层被淹的楼层。", "24": "代表团前往司法部时经过这里。（第2季第4集）", "26": "26 层的酒吧被砸，整层几乎爆发骚乱。（第1季第7集）", "27": "朱丽叶和比林斯经过这里。（第1季第5集）", "29": "查尔斯·马丁的 2926 号公寓，位于本层上部。（第1季第5集）", "30": "搜查遗物时司法部设立的楼梯检查站。（第1季第8集）17 号中则是朱丽叶潜水抵达的水泵。（第2季第7集）", "31": "里贾娜·杰克逊打开风扇干扰窃听，并交出一本介绍佐治亚州的书。（第1季第6集）", "33": "代表团前往司法部时经过这里。（第2季第4集）", "36": "朱丽叶把 PEZ 糖果盒遗物藏进特朗布尔的浴室柜。（第1季第6集）", "42": "叛乱后纪元 126 年，乔治·威尔金斯的住址为 42311 号公寓。（第1季第1集 档案）", "45": "弗兰基·布朗的 4529 号公寓。（第1季第5集）", "47": "登顶竞赛的选手经过这里。（第1季第5集）", "50": "50 层平台上的人群喊道：“欢迎来到中层，詹斯市长！”（第1季第3集）", "52": "监视人员替代了 52 层被砸坏的摄像头。（第1季第7集）", "55": "渗透过滤厂；维生素 D+ 在这里被加入水中。（第3季第6集）这里也发生过对峙。（第3季第9集）", "59": "59 层的磨坊每隔一周就会故障。（第2季第5集）", "60": "沃克爬到 60 层寻找医疗物资。（第3季第2集）人群骚动从 60 层蔓延到 130 层。（第2季第5集）", "61": "朱丽叶在这座回收站交出了母亲和弟弟的遗物。（第1季第4集）", "62": "育婴室、长期护理与停尸房；霍尔斯顿曾将硬盘藏进格洛丽亚的通风口。（第1季第7集）", "63": "拉尔夫·梅尔比的 63324 号公寓；这个名字后来成为司法部的陷阱。（第3季第8集）", "66": "静思区、纪念区、水景花园与玻璃温室；也就是吃草莓的公园。（第1季第3集）", "68": "乔治的维修摊、“局外人”在储藏室的会面，以及墙中的门。（第3季第2集）", "70": "朱丽叶在 70 层咖啡馆被捕。（第1季第10集）这里还有矿区入口和搬运工站。", "71": "标牌上的农业过滤区，包括水培、果树、水产养殖和乳业。", "72": "汉克的表亲住在这里，曾询问学校是否安全。（第1季第5集）", "73": "标牌标明的农场楼层；卡米尔把诺克斯和雪莉藏在这里的隐蔽空间。（第2季第5集）", "74": "住宅编号从 74/1 到 74/86，每层约有 86 套公寓。", "75": "估计位置：马恩斯说中层副警署的辖区向上下各延伸二十五层。（第1季第4集）", "76": "“安全后，去 76 层泵房。”这里是朱丽叶与西姆斯约定见面的地点。（第3季第4集）", "78": "汉娜·尼科尔斯在这里制作放大镜，司法部将它砸毁。（第1季第8集）广播也曾宣布停电。", "79": "朱丽叶深夜通过无线电联系沃克。（第1季第6集）", "80": "“我是 80 层的拉方丹，从这里到农场一切平安。”（第1季第3集）", "83": "逃亡者藏在 73 层那晚，阿萨住在 83 层前妻家中。（第2季第5集）", "85": "安宁疗护区；伯纳德说，维修信使的母亲在这里工作。（第2季第8集）", "87": "诺克斯和雪莉监督断层重建期间的住处。（第3季第2集）", "90": "90 层水泵是针对沃克的陷阱。（第2季第8集）这里也是断层上端和奥西滑轮座椅的位置。（S3）", "91": "皮特的炸弹让这里的楼梯彻底消失。（第2季第10集）", "92": "“92 层，两名搬运工正在下行。”（第2季第5集）这里位于断层上缘。", "98": "丹尼把硬盘信号转接到 98 层，欺骗监视人员。（第1季第9集）", "105": "桑迪调到这里：“那是中层下部，不是深层。”（第1季第5集）", "110": "“我在 110 层部署了五十名突击队员。”西姆斯在这里埋伏代表团。（第2季第4集）", "119": "伯纳德走下一百层，在这里与比林斯见面。（第2季第9集）穿橙色衣服的矿工也曾出现。（第2季第4集）", "120": "乔治凌晨三点从这里翻过栏杆。（第1季第1集）机械部夺取十层后，路障也移到这里。", "122": "“来自 122 层的朋友们，朱丽叶还活着。”农民们通过垃圾道送来食物。（第2季第6集）", "123": "120 层战线下方，反叛者与突击队在此行动。（第2季第10集）", "124": "卡拉·麦克莱恩的公寓；沃克爬到这里寻找优质隔热胶带。（第1季第10集）", "125": "卡拉对沃克说，125 层以上根本没人知道你是谁。（第2季第5集）", "126": "这里的增强器把绿色外界影像送上所有屏幕，持续十秒。（第1季第10集）", "129": "紧挨着 130 层路障的上方。（第2季第6集）", "130": "司法部设置的路障；诺克斯和雪莉借助偷来的绞盘从旁边降下。（第2季第5集）", "132": "“我住在 132 层。”桑迪在路障处被拦下。（第2季第5集）", "135": "窃听者住在 135 层的姨妈报告，深层居民正携带武器向上行进。（第2季第6集）", "140": "乔治的包裹放在床上；地板嗡鸣时，雪莉在走廊找到身体不适的朱丽叶。（第1季第3集）", "144": "沃克的工作台、工具制造间、焚化炉、循环风机，以及地板上涂着的 144。"};function Wf(e){let t=Vf(e),n=e<=49?`上层区`:e<=119?`中层区`:`深层区`;return{level:e,name:Hf[e]||t.dept,dept:t.dept,zone:n,note:Uf[e]||``}}var Gf=["《公约》禁止电梯；跨越断层的滑轮座椅，是 143 年来第一部合法升降装置。", "两扇滑动门各重 25 吨，可阻挡小至 50 纳米的颗粒。", "地堡设计可承受两英里外的三千万吨级爆炸。", "最近一次人口普查为 10,112 人；第三季第三集时，算法计算约剩 9,913 人。", "“传承”保存着 352 年的记录，更早的内容一片空白。", "六座地堡曾被完全重置，这一座发生在 140 年前。", "一台蒸汽轮机为 144 层供电，蒸汽来自未知的地下深处。", "信息部通过 1 号地堡的线路供电，即使发电机停转也仍然明亮。", "共有十二座回收站，各按自己的时间表，每小时向垃圾道倾倒一次废物。", "信号增强器每三十层设置一个；126 层的设备曾让所有屏幕显示绿色天空十秒钟。", "二十年前灯泡库存足够使用七十年，如今只剩两年。", "矿道横向开凿不得超过 200 英尺，《公约》借此阻止居民挖向邻近地堡。", "每间公寓的镜子后都藏着镜头；120 层以下的大部分镜头在叛乱中被砸毁。", "食堂墙屏展示真实外界，清洁头盔展示的却是谎言。", "17 号地堡的水位位于 22 与 23 层之间，发电机沉在上百层深的水下。", "詹斯市长走下全部 144 层，把警徽交给朱丽叶，再走回顶层，全程都在饮用有毒的水。", "五十座地堡坐落在佐治亚州三十万英亩农田下，1 号居中，外围七组各有七座。", "把掘进机吊出一英里深的井太昂贵，创始者便将它留在三十英尺厚的混凝土封盖之下。", "沃克二十五年没有离开 144 层工坊，直到她为一卷隔热胶带爬上物资部。", "“安全保障”是一根通往 14 层司法部的管道，里面的毒物足以杀死一万名居民。"],Kf={silo:{label:`地堡全景`,position:[430,40,1320],target:[0,-560,0]},surface:{label:`地表`,position:[-180,70,260],target:[0,6,-40]},top:{label:`上层区`,position:[150,60,330],target:[0,-90,0]},below:{label:`机械部及地下`,position:[150,$(140)+40,360],target:[0,$(144)-45,0]}};function qf(e){let t=[],n={current:null,flying:!1,onChange(e){return t.push(e),()=>{let n=t.indexOf(e);n>=0&&t.splice(n,1)}},list(){return If.filter(t=>t.modes.includes(e.silo.mode))},async go(r,{fly:i=!0}={}){let a=typeof r==`string`?Lf[r]:r;if(!a){console.warn(`[tour] unknown poi`,r);return}a.modes.includes(e.silo.mode)||e.silo.set(a.modes[0]),n.current=a,e.ui?.chip?.(null);for(let e of t)e(a);if(!i){e.camera.position.set(...a.cam.position),e.controls.target.set(...a.cam.target),e.controls.update();return}n.flying=!0;let o=e.camera.position.distanceTo({x:a.cam.position[0],y:a.cam.position[1],z:a.cam.position[2]});try{await e.flyTo({...a.cam,duration:Math.min(4.2,1.4+o/500)})}finally{n.flying=!1}},async view(r,{fly:i=!0}={}){let a=Kf[r];if(a){e.ui?.chip?.(null),n.current=null;for(let e of t)e(null);if(!i){e.camera.position.set(...a.position),e.controls.target.set(...a.target),e.controls.update();return}n.flying=!0;try{await e.flyTo({position:a.position,target:a.target,duration:2.6})}finally{n.flying=!1}}},home(){return n.view(`silo`)},async level(r,{fly:i=!0}={}){let a=$(r),o={position:[110,a+42,250],target:[0,a+2,0]};n.current={id:`level-`+r,kind:`level`,level:r,modes:[`18`,`17`],cam:o,anchor:[0,a+3,0]};for(let e of t)e(n.current);if(!i){e.camera.position.set(...o.position),e.controls.target.set(...o.target),e.controls.update();return}n.flying=!0;try{await e.flyTo({...o,duration:2.2})}finally{n.flying=!1}},next(){let e=n.list(),t=n.current;if(t&&t.kind===`level`){let r=e.find(e=>e.level>t.level);return n.go(r||e[0])}let r=t?e.indexOf(t):-1;return n.go(e[(r+1)%e.length])},prev(){let e=n.list(),t=n.current;if(t&&t.kind===`level`){let r=[...e].reverse().find(e=>e.level<t.level);return n.go(r||e[e.length-1])}let r=t?e.indexOf(t):0;return n.go(e[(r-1+e.length)%e.length])},clear(){n.current=null;for(let e of t)e(null)}};return e.canvas.addEventListener(`pointerdown`,()=>{n.flying&&=(e.cancelFlight(),!1)}),window.addEventListener(`keydown`,e=>{e.target&&(e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)||(e.key===`ArrowRight`||e.key===`j`?n.next():e.key===`ArrowLeft`||e.key===`k`?n.prev():(e.key===`Escape`||e.key===`Home`)&&n.home())}),e.tour=n,n}var Jf=Wf;function Yf(){try{let e=new URL(`https://donate.stripe.com/7sYdRb7552j0cfE3oubsc00`);return e.protocol===`https:`?e.href:``}catch{return``}}function Xf(e){let t=document.getElementById(`ui`),n=Yf();t.innerHTML=`
    <div class="ui-top-left">
      <div class="brand">
        <div class="brand-title">地堡</div>
      ...
      <nav id="legend" aria-label="地点导航"></nav>
    </div>
    <div class="ui-top-right">
      <div class="stats" id="stats"></div>
      <div class="hint">拖动旋转 · 滚轮缩放 · 右键拖动平移 · ← → 切换地点 · Esc 返回全景</div>
      <div class="credits" id="credits"></div>
    </div>
    <div id="chip" class="chip"></div>
    <div id="zones"></div>
    <div id="dyk" class="dyk"></div>
    <div id="intro" class="intro"><div class="intro-a">18 号地堡</div><div class="intro-b">144 层 · 深逾一公里 · 10,112 位居民</div></div>
    <aside id="card" class="card" aria-live="polite">
      ...
      <div class="card-eps" id="card-eps"></div>
      <div class="card-nav"><button id="card-prev">‹ 上一处</button><span id="card-index"></span><button id="card-next">下一处 ›</button></div>
    </aside>
    <div class="toast" id="toast"></div>
  `;let r=document.getElementById(`leaders`);e.ui={credit(e){let n=t.querySelector(`#credits`),r=document.createElement(`div`);r.textContent=e,n.appendChild(r)},toast(e,n=2600){let r=t.querySelector(`#toast`);r.textContent=e,r.classList.add(`show`),clearTimeout(r._h),r._h=setTimeout(()=>r.classList.remove(`show`),n)},chip(e,n,r){let i=t.querySelector(`#chip`);if(!e){i.classList.remove(`show`);return}i.textContent=e,i.style.left=n+`px`,i.style.top=r+`px`,i.classList.add(`show`)}};let i=t.querySelector(`#mode`),a=new Map;for(let[t,n]of[[`18`,`18 号地堡`],[`17`,`17 号地堡`]]){let r=document.createElement(`button`);r.textContent=n,r.title=t===`17`?`被水淹没、失去供电的邻居`:`家园`,r.addEventListener(`click`,()=>e.silo.set(t)),i.appendChild(r),a.set(t,r)}let o=t.querySelector(`#views`);for(let[t,n]of Object.entries(Kf)){let r=document.createElement(`button`);r.textContent=n.label,r.addEventListener(`click`,()=>e.tour.view(t)),o.appendChild(r)}let s=t.querySelector(`#legend`),c=new Map;function l(){s.innerHTML=``,c.clear();let t=e.tour?e.tour.list():If.filter(t=>t.modes.includes(e.silo.mode));for(let n of[{id:`surface`,name:`地表`,from:0,to:0},...Tf]){let r=t.filter(e=>n.id===`surface`?e.level===0:e.level>=n.from&&e.level<=n.to);if(!r.length)continue;let i=document.createElement(`div`);i.className=`legend-zone`,i.textContent=n.name,s.appendChild(i);for(let t of r){let n=zf[t.id]||{},r=document.createElement(`button`);r.className=`legend-item`,r.dataset.id=t.id,r.innerHTML=`<span class="lvl">${t.level?t.level:`↑`}</span><span class="name">${n.short||n.name||t.id}</span>`,r.addEventListener(`click`,()=>e.tour.go(t.id)),r.addEventListener(`pointerenter`,()=>{u=t.id}),r.addEventListener(`pointerleave`,()=>{u===t.id&&(u=null)}),s.appendChild(r),c.set(t.id,{el:r,poi:t})}}d(),m=!0}let u=null;function d(){let t=e.tour?.current?.id;for(let[e,n]of c)n.el.classList.toggle(`active`,e===t)}let f=new Map,p=new Map,m=!0,h=0,g=new K;function _(){p=new Map;for(let[e,t]of c){let n=t.el.getBoundingClientRect();p.set(e,{x:n.right,y:n.top+n.height/2,visible:n.width>0})}m=!1}window.addEventListener(`resize`,()=>{m=!0});function v(n){h+=n,(m||h>.5)&&(_(),h=0);let i=window.innerWidth,a=window.innerHeight,o=t.classList.contains(`hidden`)||document.documentElement.classList.contains(`mobile`),s=e.camera.position.distanceTo(e.controls.target),l=e.tour?.current?.id,d=new Set;for(let[t,n]of c){let c=p.get(t),m=!o&&c&&c.visible&&(s>140||t===l||t===u),h=f.get(t);if(!m){h&&(h.style.display=`none`);continue}g.set(...n.poi.anchor).project(e.camera);let _=g.z>1,v=(g.x*.5+.5)*i,y=(-g.y*.5+.5)*a;if(_||v<-50||v>i+50||y<-50||y>a+50){h&&(h.style.display=`none`);continue}h||(h=document.createElementNS(`http://www.w3.org/2000/svg`,`g`),h.innerHTML=`<path class="leader"/><circle class="leader-dot" r="3.2"/>`,r.appendChild(h),f.set(t,h)),d.add(t),h.style.display=``,h.classList.toggle(`active`,t===l||t===u);let b=c.x+6,x=c.y,S=Math.max(b+26,v-Math.min(80,Math.abs(v-b)*.25));h.querySelector(`path`).setAttribute(`d`,`M${b.toFixed(1)},${x.toFixed(1)} L${S.toFixed(1)},${x.toFixed(1)} L${v.toFixed(1)},${y.toFixed(1)}`);let C=h.querySelector(`circle`);C.setAttribute(`cx`,v.toFixed(1)),C.setAttribute(`cy`,y.toFixed(1))}for(let[e,t]of f)!d.has(e)&&!c.has(e)&&(t.remove(),f.delete(e))}e.onLate(e=>v(e));let y=t.querySelector(`#zones`),b=[{text:`上层区`,sub:`第 1—49 层`,anchor:[96,$(1)+2,0]},{text:`中层区`,sub:`第 50—119 层`,anchor:[96,$(50)+2,0]},{text:`深层区`,sub:`第 120—144 层`,anchor:[96,$(120)+2,0]},{text:`地下深处`,sub:`发电机 · 掘进机`,anchor:[96,bf.bottomSlab-4,0]},{text:`中央大楼梯`,sub:`288 圈楼梯 · 432 座桥`,anchor:[0,$(30),0],center:!0}].map(e=>{let t=document.createElement(`div`);return t.className=`zone-marker`+(e.center?` center`:``),t.innerHTML=`<b>${e.text}</b><i>${e.sub}</i>`,y.appendChild(t),{...e,el:t}});function x(){let n=e.camera.position.distanceTo(e.controls.target),r=n>520&&!t.classList.contains(`hidden`),i=window.innerWidth,a=window.innerHeight;for(let t of b){if(!r){t.el.style.opacity=0;continue}if(g.set(...t.anchor).project(e.camera),g.z>1){t.el.style.opacity=0;continue}let o=(g.x*.5+.5)*i,s=(-g.y*.5+.5)*a;t.el.style.opacity=Math.min(1,(n-520)/400),t.el.style.transform=`translate(${o.toFixed(0)}px, ${s.toFixed(0)}px)`}}e.onLate(x);let S=t.querySelector(`#dyk`),C=Gf||[`The Pact bans elevators — the pulley chair over the Gap is the first legal lift in 143 years.`,`The blast doors weigh 25 tons each and keep out particles down to 50 nanometres.`,`Signal boosters sit every 30 levels — Level 126 pushed the Carmody video to every screen.`,`IT never loses power: its line comes straight from Silo 1.`],w=Math.floor(Math.random()*C.length),T=0;function E(){S.textContent=C[w%C.length],S.classList.add(`show`)}e.onUpdate(t=>{if(T+=t,D.classList.contains(`show`)||!e.ready){S.classList.contains(`show`)&&S.classList.remove(`show`),T=0;return}!S.classList.contains(`show`)&&T>4?(E(),T=0):S.classList.contains(`show`)&&T>11&&(S.classList.remove(`show`),w++,T=2)});let D=t.querySelector(`#card`),O={level:D.querySelector(`#card-level`),title:D.querySelector(`#card-title`),sub:D.querySelector(`#card-sub`),body:D.querySelector(`#card-body`),facts:D.querySelector(`#card-facts`),eps:D.querySelector(`#card-eps`),index:D.querySelector(`#card-index`)};D.querySelector(`#card-close`).addEventListener(`click`,()=>{e.tour.clear()}),D.querySelector(`#card-prev`).addEventListener(`click`,()=>e.tour.prev()),D.querySelector(`#card-next`).addEventListener(`click`,()=>e.tour.next());function k(t){if(!t){D.classList.remove(`show`);return}if(t.kind===`level`){let e=Jf(t.level),n=Ef(t.level);O.level.textContent=`第 ${t.level} 层 · ${n.name.toUpperCase()} · −${Math.round(t.level*7.6)} 米`,O.title.textContent=e.name,O.sub.textContent=e.dept===e.name?``:e.dept,O.body.textContent=e.note||`剧中暂时还没有展示发生在这里的故事。`,O.facts.innerHTML=``,O.eps.textContent=``,O.index.textContent=`点击亮灯的房间进入`,D.classList.add(`show`);return}let n=zf[t.id]||{},r=t.level?Ef(t.level):null;O.level.textContent=t.level===0?`地表`:t.level>144?t.id===`digger`?`三十英尺封盖之下`:`第 144 层以下`:`第 ${t.level} 层${t.id===`gap`?`–92`:``}${r?` · `+r.name.toUpperCase():``}`,O.title.textContent=n.name||t.id,O.sub.textContent=n.sub||``,O.body.textContent=n.body||``,O.facts.innerHTML=(n.facts||[]).map(e=>`<li>${e}</li>`).join(``),O.eps.textContent=n.episodes?`出现集数：`+n.episodes:``;let i=e.tour.list(),a=i.indexOf(t);O.index.textContent=a>=0?`${a+1} / ${i.length}`:``,D.classList.add(`show`)}window.addEventListener(`keydown`,n=>{n.target&&(n.target.tagName===`INPUT`||n.target.tagName===`TEXTAREA`)||(n.key===`h`?(t.classList.toggle(`hidden`),r.classList.toggle(`hidden`)):n.key===`s`&&e.silo.set(e.silo.mode===`17`?`18`:`17`))});let A=t.querySelector(`#stats`);return e.onStats=e=>{A.innerHTML=`<span>${e.fps} fps</span><span>${(e.triangles/1e6).toFixed(2)}M tris</span><span>${(e.sceneTriangles/1e6).toFixed(2)}M in scene</span><span>${e.drawCalls} calls</span>`},e.params.shot&&t.classList.add(`shot`),e.params.stats===`1`&&document.documentElement.classList.add(`stats`),e.params.ui===`0`&&(t.classList.add(`hidden`),r.classList.add(`hidden`)),e.ui.bind=()=>{let n=!0;e.silo.onChange(t=>{for(let[e,n]of a)n.classList.toggle(`active`,e===t);document.documentElement.classList.toggle(`silo17`,t===`17`),l(),e.tour.current&&!e.tour.current.modes.includes(t)&&e.tour.clear(),b[0].el.querySelector(`b`).textContent=t===`17`?`上层区 · 黑暗`:`上层区`,n||e.ui.toast(t===`17`?`17 号地堡——洪水已到 23 层，只有 19 层的信息部仍有电力`:`18 号地堡——我们的家`,3200),n=!1});let r=t.querySelector(`#intro`);if(!e.params.shot&&!e.params.poi&&!e.params.cam){e.silo.mode===`17`&&(r.querySelector(`.intro-a`).textContent=`17 号地堡`,r.querySelector(`.intro-b`).textContent=`淹至 23 层 · 一层灯火 · 少数幸存者`);let t=0,n=!1,i=e.onUpdate(a=>{e.ready&&(t+=a,!n&&t>.6&&(r.classList.add(`show`),n=!0),n&&t>6.4&&(r.classList.remove(`show`),i()))})}e.tour.onChange(e=>{d(),k(e)})},e.ui.showCard=k,e.ui}function Zf(e,t){let n=document.getElementById(`loader-text`);n&&(n.textContent=e);let r=document.getElementById(`loader-fill`);r&&t!==void 0&&(r.style.width=Math.round(t*100)+`%`)}function Qf(){let e=document.getElementById(`loader`);e&&(e.classList.add(`done`),setTimeout(()=>e.remove(),900))}function $f(e,t){let n=document.createElement(`canvas`);if(e>op||t>op){let n=op/Math.max(e,t);e=Math.max(1,Math.round(e*n)),t=Math.max(1,Math.round(t*n))}return n.width=e,n.height=t,n}function ep(e,t,n=0){let r=e*374761393+t*668265263+n*1442695041|0;return r=(r^r>>>13)*1274126177,r=(r^r>>>16)>>>0,r/4294967295}function tp(e){return e*e*(3-2*e)}function np(e,t,n=0){let r=Math.floor(e),i=Math.floor(t),a=e-r,o=t-i,s=ep(r,i,n),c=ep(r+1,i,n),l=ep(r,i+1,n),u=ep(r+1,i+1,n),d=tp(a),f=tp(o);return s+(c-s)*d+(l-s)*f+(s-c-l+u)*d*f}function rp(e,t,n=4,r=0,i=2,a=.5){let o=0,s=.5,c=1,l=0;for(let u=0;u<n;u++)o+=np(e*c,t*c,r+u*17)*s,l+=s,s*=a,c*=i;return o/l}function ip(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function ap(e,{srgb:t=!0,repeat:r=1,aniso:i=8,wrap:a=!0}={}){return e.colorSpace=t?Le:``,a&&(e.wrapS=e.wrapT=n),e.repeat.set(r,r),e.anisotropy=i,e.needsUpdate=!0,e}var op=1024;function sp(e){op=e}var cp=new Map;function lp(e,t){return cp.has(e)||cp.set(e,t()),cp.get(e)}function up({size:e=512,scale:t=6,octaves:n=4,seed:r=1,colorFn:i,srgb:a=!0,key:o}={}){let s=()=>{let o=$f(e,e),s=o.getContext(`2d`),c=s.createImageData(e,e),l=c.data;for(let a=0;a<e;a++)for(let o=0;o<e;o++){let s=o/e,c=a/e,u=rp(s*t,c*t,n,r),d=rp((s+1)*t,c*t,n,r),f=rp(s*t,(c+1)*t,n,r),p=rp((s+1)*t,(c+1)*t,n,r),[m,h,g]=i(u*(1-s)*(1-c)+d*s*(1-c)+f*(1-s)*c+p*s*c,o,a),_=(a*e+o)*4;l[_]=m,l[_+1]=h,l[_+2]=g,l[_+3]=255}return s.putImageData(c,0,0),ap(new Ii(o),{srgb:a})};return o?lp(o,s):s()}function dp(e,t=2){let n=e.width,r=e.height,i=e.getContext(`2d`).getImageData(0,0,n,r).data,a=$f(n,r),o=a.getContext(`2d`),s=o.createImageData(n,r),c=s.data,l=(e,t)=>i[((t+r)%r*n+(e+n)%n)*4]/255;for(let e=0;e<r;e++)for(let r=0;r<n;r++){let i=(l(r+1,e)-l(r-1,e))*t,a=(l(r,e+1)-l(r,e-1))*t,o=-i,s=-a,u=Math.hypot(o,s,1),d=(e*n+r)*4;c[d]=(o/u*.5+.5)*255,c[d+1]=(s/u*.5+.5)*255,c[d+2]=(1/u*.5+.5)*255,c[d+3]=255}return o.putImageData(s,0,0),ap(new Ii(a),{srgb:!1})}function fp(e,t){let n=$f(e,e),r=n.getContext(`2d`),i=r.createImageData(e,e);for(let n=0;n<e;n++)for(let r=0;r<e;r++){let a=Math.max(0,Math.min(1,t(r/e,n/e,r,n)))*255,o=(n*e+r)*4;i.data[o]=i.data[o+1]=i.data[o+2]=a,i.data[o+3]=255}return r.putImageData(i,0,0),n}function pp({seed:e=5,tiles:t=4,base:n=165,jointDark:r=60,key:i=`concrete`}={}){return lp(i+e+t+n,()=>{let i=1024,a=.012,o=(e,n)=>{let r=e*t%1,i=n*t%1,o=Math.min(r,1-r),s=Math.min(i,1-i),c=Math.min(o,s);return c<a?1-c/a:0};return{map:up({size:i,scale:12,octaves:5,seed:e,colorFn:(a,s,c)=>{let l=s/i,u=c/i,d=o(l,u),f=rp(l*3+7,u*3,3,e+3),p=ep(s,c,e+1),m=n+(a-.5)*28-(f-.5)*30+(p>.985?20:0),h=Math.floor(l*t),g=Math.floor(u*t);return m+=(ep(h,g,e+5)-.5)*14,m=m*(1-d)+r*d,[m,m,m*.98]}}),normalMap:dp(fp(512,(t,n,r,i)=>{let a=o(t,n);return .5+(ep(r,i,e+2)-.5)*.25+(rp(t*20,n*20,3,e)-.5)*.3-a*.5}),1.5)}})}var mp=`#243e8c`;function hp(e){let{text:t=``,width:n=512,height:i=128,font:a=`Helvetica Neue, Helvetica, Arial, sans-serif`,color:o=`#ffffff`,bg:s=mp,align:c=`center`,padding:l=16,weight:u=`700`,fontSize:d,lineHeight:f=1.15,border:p=0,borderColor:m=`#ffffff`,draw:h=null,post:g=null,letterSpacing:_=0,key:v=null,transparent:y=!1,valign:b=`middle`,italic:x=!1}=e,S=()=>{let e=$f(n,i),v=e.getContext(`2d`);y||(v.fillStyle=s,v.fillRect(0,0,n,i)),p>0&&(v.strokeStyle=m,v.lineWidth=p,v.strokeRect(p/2,p/2,n-p,i-p)),h&&h(v,n,i);let S=String(t).split(`
`),C=d;C||=Math.min((i-l*2)/(S.length*f),(n-l*2)/Math.max(1,...S.map(e=>e.length*.58))),v.font=`${x?`italic `:``}${u} ${C}px ${a}`,v.fillStyle=o,v.textAlign=c,v.textBaseline=`middle`,_&&(v.letterSpacing=_+`px`);let w=c===`left`?l:c===`right`?n-l:n/2,T=S.length*C*f,E=b===`top`?l+C*f/2:b===`bottom`?i-l-T+C*f/2:i/2-T/2+C*f/2;S.forEach((e,t)=>v.fillText(e,w,E+t*C*f)),g&&g(v,n,i);let D=new Ii(e);return D.colorSpace=Le,D.anisotropy=8,D.wrapS=D.wrapT=r,D.needsUpdate=!0,D};return v?lp(`text:`+v,S):S()}function gp(e,{emissive:t=.9,transparent:n=!1,doubleSide:r=!1}={}){let i=new Do({map:e,emissiveMap:e,emissive:new Y(16777215),emissiveIntensity:t,roughness:.6,metalness:0,transparent:n,side:r?2:0});return n&&(i.alphaTest=.1),i}var _p=new Map;function vp(e,{roughness:t=.6,metalness:n=0,emissive:r=null,emissiveIntensity:i=1,side:a=0,key:o=null}={}){let s=`color:`+e+t+n+(r||``)+i+a+(o||``);if(_p.has(s))return _p.get(s);let c=new Do({color:new Y(e),roughness:t,metalness:n,side:a});return r&&(c.emissive=new Y(r),c.emissiveIntensity=i),_p.set(s,c),c}function yp(e,{size:t=6,reach:n=150,fadeOver:r=250}={}){if(e.params.pool===`0`)return null;let i=[];e.scene.updateMatrixWorld(!0),e.scene.traverse(e=>{e.isPointLight&&i.push(e)});let a=new K;for(let e of i){let t=[],n=e.parent;for(;n;)t.push(n),n=n.parent;e.userData.pool={world:a.setFromMatrixPosition(e.matrixWorld).clone(),chain:t},e.removeFromParent()}let o=[];for(let n=0;n<t;n++){let t=new ss(16777215,0,1,2);t.castShadow=!1,t.name=`pool-`+n,e.scene.add(t),o.push(t)}let s=[],c=e=>{for(let t of e.userData.pool.chain)if(t.visible===!1)return!1;return e.visible&&e.intensity>0};function l(){let t=e.controls.target;s.length=0;for(let e of i){if(!c(e))continue;let n=e.userData.pool.world.distanceTo(t);s.push({l:e,d:n,key:n-e.distance})}s.sort((e,t)=>e.key-t.key);for(let e=0;e<o.length;e++){let t=s[e],i=o[e];if(!t){i.intensity=0;continue}let a=1-Et.smoothstep(t.d,n,n+r);i.position.copy(t.l.userData.pool.world),i.color.copy(t.l.color),i.distance=t.l.distance||60,i.decay=t.l.decay,i.intensity=t.l.intensity*a}}return l(),e.onLate(l),console.log(`[lights] pooled ${i.length} point lights into ${t} (reach ${n} m)`),{sources:i,pool:o,update:l}}function bp(e,{minCount:t=200,bands:n=12}={}){if(e.params.chunks===`0`)return{chunked:0};let r=[];e.groups.world.traverse(e=>{e.isInstancedMesh&&e.count>=t&&!e.userData.noChunk&&r.push(e)}),e.groups.dynamic.traverse(e=>{e.isInstancedMesh&&e.count>=t&&!e.userData.noChunk&&r.push(e)});let i=[],a=0,o=0;for(let e of r){let t=e.count,r=Math.ceil(t/n);if(r<8)continue;let s=e.geometry,c=Object.entries(s.attributes).filter(([,e])=>e.isInstancedBufferAttribute),l=[];for(let n=0;n<t;n+=r){let i=Math.min(t,n+r),a=i-n,o=s;if(c.length){o=new Er,o.setIndex(s.index);for(let[e,t]of Object.entries(s.attributes))t.isInstancedBufferAttribute?o.setAttribute(e,new vi(t.array.subarray(n*t.itemSize,i*t.itemSize),t.itemSize,t.normalized)):o.setAttribute(e,t);o.boundingSphere=s.boundingSphere,o.boundingBox=s.boundingBox}let u=new Ei(o,e.material,a);u.instanceMatrix=new vi(e.instanceMatrix.array.subarray(n*16,i*16),16),e.instanceColor&&(u.instanceColor=new vi(e.instanceColor.array.subarray(n*3,i*3),3)),u.castShadow=e.castShadow,u.receiveShadow=e.receiveShadow,u.renderOrder=e.renderOrder,u.layers.mask=e.layers.mask,u.userData={...e.userData,chunkOf:e.name},u.name=`${e.name}#${l.length}`,u.computeBoundingSphere(),u.frustumCulled=!0,l.push(u),e.add(u)}e.count=0,e.userData.chunks=l,i.push({m:e,kids:l,mv:e.instanceMatrix.version,cv:e.instanceColor?e.instanceColor.version:0}),a++,o+=t}return e.onUpdate(()=>{for(let e of i){if(e.m.instanceMatrix.version!==e.mv){e.mv=e.m.instanceMatrix.version;for(let t of e.kids)t.instanceMatrix.needsUpdate=!0,t.computeBoundingSphere()}if(e.m.instanceColor&&e.m.instanceColor.version!==e.cv){e.cv=e.m.instanceColor.version;for(let t of e.kids)t.instanceColor.needsUpdate=!0}}}),console.log(`[chunks] ${a} instanced meshes (${o} instances) split into ${n}-band chunks`),{chunked:a,total:o}}var xp=`modulepreload`,Sp=function(e){return new URL(`../`+e,import.meta.url).href},Cp={},wp=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Sp(t,n),t=s(t),t in Cp)return;Cp[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:xp,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};window.__LAX_READY__=!1;var Tp=[[`surface`,()=>wp(()=>import(`./surface-B_hRNS2v.js`),[])],[`shell`,()=>wp(()=>import(`./shell-DhYnyQu6.js`),__vite__mapDeps([0,1]))],[`shaft`,()=>wp(()=>import(`./shaft-B0Z7d-vK.js`).then(e=>e.t),__vite__mapDeps([2,3]))],[`rooms/top`,()=>wp(()=>import(`./top-g78mB-vG.js`),__vite__mapDeps([4,5]))],[`rooms/mids`,()=>wp(()=>import(`./mids-CkdOCsSA.js`),__vite__mapDeps([6,5]))],[`rooms/deep`,()=>wp(()=>import(`./deep-D6E1CDdh.js`),__vite__mapDeps([7,5]))],[`silo17`,()=>wp(()=>import(`./silo17-CkgNQP9_.js`),[])],[`interact`,()=>wp(()=>import(`./interact-DoSP149e.js`),[])]];async function Ep(){let e=new Wd(document.getElementById(`c`));window.app=e,sp(e.perf.textureSize),console.log(`[perf] tier`,e.perf.tier,JSON.stringify(e.perf)),e.perf.mobile&&document.documentElement.classList.add(`mobile`),Af(e),qf(e),Xf(e);let t=e.params.only?e.params.only.split(`,`):null,n=e.params.skip?e.params.skip.split(`,`):[],r=performance.now();for(let r=0;r<Tp.length;r++){let[i,a]=Tp[r];if(!(t&&!t.includes(i)&&i!==`interact`||n.includes(i))){Zf(`正在构建`+({surface:"地表",shell:"外壳",shaft:"竖井","rooms/top":"上层房间","rooms/mids":"中层房间","rooms/deep":"深层房间",silo17:"17 号地堡",interact:"交互"}[i]||"场景")+`…`,.06+r/Tp.length*.88),await new Promise(e=>setTimeout(e,16));try{let t=await a(),n=performance.now();await t.build(e),console.log(`[build] ${i} ${(performance.now()-n).toFixed(0)} ms`)}catch(e){console.error(`[build] module ${i} failed`,e)}}}e.groups.world.traverse(e=>{e.isMesh&&/^shell-/.test(e.name)&&!/^shell-(wall|slabs)$/.test(e.name)&&(e.castShadow=!1)}),yp(e,{size:6}),bp(e,{minCount:200,bands:12});for(let[t,n]of Object.entries(Kf))e.registerPreset(t,n);if(e.ui.bind(),e.start(),console.log(`[build] total ${(performance.now()-r).toFixed(0)} ms`),Zf(`准备就绪`,1),Qf(),e.setReady(),!e.params.cam&&!e.params.preset&&!e.params.shot&&!e.params.poi){let t=Kf.surface,n=Kf.silo;e.camera.position.set(...t.position),e.controls.target.set(...t.target),e.controls.update(),setTimeout(()=>e.flyTo({position:n.position,target:n.target,duration:5.5}),1400)}}Ep().catch(e=>{console.error(e),Zf(`错误：`+e.message)});export{Vi as $,$ as A,no as At,zd as B,gf as C,As as Ct,Sf as D,To as Dt,bf as E,Le as Et,Fd as F,go as Ft,wd as G,Bd as H,Hd as I,So as It,Bi as J,Cd as K,Id as L,G as Lt,xf as M,Kr as Mt,Vd as N,Mr as Nt,vf as O,xa as Ot,Pd as P,ho as Pt,ea as Q,Nd as R,K as Rt,hf as S,Dt as St,pf as T,uo as Tt,Rd as U,Ld as V,Dd as W,Er as X,fr as Y,Ii as Z,wf as _,Do as _t,$f as a,ao as at,ff as b,ss as bt,ip as c,co as ct,np as d,u as dt,Y as et,Vf as f,q as ft,Rf as g,Oo as gt,If as h,ni as ht,rp as i,on as it,Cf as j,mo as jt,yf as k,fo as kt,gp as l,vi as lt,zf as m,mi as mt,vp as n,Hi as nt,up as o,X as ot,Wf as p,Yt as pt,Q as q,pp as r,Ue as rt,dp as s,wn as st,wp as t,Ui as tt,hp as u,Ei as ut,mf as v,ba as vt,Of as w,n as wt,_f as x,ga as xt,Df as y,lo as yt,Md as z};